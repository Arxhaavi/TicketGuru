...
public class TicketguruApplication {
	...
	public CommandLineRunner loadData(LocationRepository locationRepository, EventRepository eventRepository,
		...
		return (args) -> {
			...
			AppUser user1 = new AppUser("user", "$2a$10$4XXGNu904amNx2Q0tPL4OOZiLP012ULGVI2a8Em4SAJGCtQG1WBJu",
					"ROLE_USER"); // password: user
			AppUser user2 = new AppUser("admin", "$2a$10$YAvqdDch33w5BecjHl6WP.LjpNaYy9jQlTcE.Krl3ib7VvzRiKUta",
